			...
			<div class="secContentsInner">
				<div class="secBtnHead">
					<div class="secBtnHead-check">
						{{ html()->form('GET', '/admin/client/enter/list')->id('listform')->attribute('name', 'listform')->open() }}
				...
				<table class="tbl-progress" id="beingTable">
					...
					@foreach ($endList as $int)
						<tr>
							...
							{{ html()->form('POST', '/admin/client/enter/save')->attribute('name', 'progform' . $int->id)->open() }}
