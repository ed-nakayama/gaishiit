...
<head>
    <titleインダストリ管理 | {{ config('app.name', 'Laravel') }}</title>
</head>
                        ...
                        <div class="secContentsInner">
                            ...
                            <div class="secBtnHead">
                                <div class="secBtnHead-btn">
                                   {{ Form::open(['url' => '/admin/industorycat/add', 'name' => 'addform' , 'id' => 'addform']) }}
                                    <ul class="item-btn">
                                       <li></li>
                                       <li style="width: 300px;"><input type="text" name="name" value="{{ old('name') }}" placeholder="インダストリ名"></li>
							...
							@endif
                             ...
                             <table class="tbl-cat-5th mb-ajust" id="memberTable">
                                ...
                                <tr>
                               {{ Form::open(['url' => '/admin/industorycat/store', 'name' => 'catform' . $cat->id ]) }}
