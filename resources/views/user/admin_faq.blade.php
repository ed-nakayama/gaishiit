...
@section('addheader')
	<title>お問い合わせ｜{{ config('app.title') }}</title>
    <link href="{{ asset('css/department.css') }}" rel="stylesheet">

	<meta property="og:type" content="article" />
	<meta property="og:title" content="お問い合わせ｜{{ config('app.title') }}" />
	<meta property="og:description" content="お問い合わせ｜{{ config('app.description') }}" />
