...
@section('addheader')
	...
	<meta name="description" content="{{ $comp->name }}の社員クチコミを掲載。給与・福利厚生・育成・法令遵守の意識・社員のモチベーション・ワークライフバランス・リモート勤務・定年という8つのテーマに分かれたクチコミをご覧いただけます。｜外資IT.comは外資系IT企業に特化したクチコミ・求人サイトです。採用が決まるまで完全無料、興味のある企業の担当者とは直接コミュニケーションも可能です。">
