...
{{--@include('comp.member_activity')--}}
	...
	<div class="mainContentsInner">
		...
		<div class="containerContents">
			...
			{{ html()->form('POST', '/comp/faq/change')->id('changeform')->attribute('name', 'changeform')->open() }}
...
<hr>
			...
			{{ html()->form('POST', '/comp/faq')->id('faqform')->attribute('name', 'faqform')->open() }}
			{{ html()->hidden('faq_id', old('faq_id' ,$faq->id)) }}
			<section class="secContents-mb">
				<div class="secContentsInner">
					...
					<div class="formContainer-add ajust">
						...
						<div class="btnContainer">
							...
							@endif
	 						<a href="javascript:faqform.submit()" class="squareBtn btn-large">保存</a>
						</div><!-- /.btn-container -->
					</div>
