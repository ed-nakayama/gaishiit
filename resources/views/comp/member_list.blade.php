	...
	<div class="containerContents">
		...
		<section class="secContents">
			<div class="secContentsInner">
				...
				<div class="secBtnHead">
					 <div class="secBtnHead-btn">
						{{ html()->form('POST', '/comp/member/add')->id('addform')->attribute('name', 'addform')->open() }}
						<ul class="item-btn">
				...
				<table class="tbl-member-5th" id="memberTable">
					...
					@foreach ($memberList as $mem)
						<tr>
							{{ html()->form('POST', '#')->id('memberform' . $mem->id)->attribute('name', 'memberform' . $mem->id)->open() }}
							{{ html()->hidden('member_id', $mem->id) }}
...
{{ html()->form('POST', '/comp/member/list')->id('memberform')->attribute('name', 'memberform')->open() }}
{{ html()->hidden('member_id', '') }}
{{ html()->hidden('del_flag', '') }}
{{ html()->hidden('admin_flag', '') }}
{{ html()->hidden('email', '') }}
{{ html()->hidden('name', '') }}
{{ html()->form()->close() }}
...
<div class="remodal" data-remodal-id="modal">
	{{ html()->form('POST', '/comp/member/more')->id('moreform')->attribute('name', 'moreform')->open() }}
