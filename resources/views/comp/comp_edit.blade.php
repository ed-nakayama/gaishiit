...
<head>
	...
	<div class="mainContentsInner-oneColumn">
		...
		<div class="containerContents">
			...
			{{ html()->form('POST', '/comp/change')->id('changeform')->attribute('name', 'changeform')->open() }}
...
<hr>
			...
			{{ html()->form('POST', '/comp/store')->id('regform')->attribute('name', 'regform')->acceptsFiles()->open() }}
			<section class="secContents-mb">
				{{-- 更新成功メッセージ --}}
				@if (session('update_success'))
					<div class="alert alert-success"  style="color:#0000ff;text-align: center;">
...
{{--
						　<a href="/comp/preview" class="squareBtn btn-large btn-navy" target="_blank" rel="noopener noreferrer">プレビュー</a>
--}}
					</div><!-- /.btn-container -->
				</div><!-- /.secContentsInner -->
			</section><!-- /.secContents -->
