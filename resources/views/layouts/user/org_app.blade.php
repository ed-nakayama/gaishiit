                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @unless (Auth::guard('user')->check())
                            ...
                            @if (Route::has('user.register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('user.register') }}">{{ __('RegistTitle') }}</a>
                                </li>
                            @endif
                        @else
                             <li class="nav-item">
                                <a class="nav-link" href="{{ route('user.mypage') }}">{{ __('Mypage') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('user.comp.list') }}">{{ __('Company Search') }}</a>
                            </li>
                            <li class="nav-item">
                               <a class="nav-link" href="{{ route('user.edit') }}">{{ __('User Info') }}</a>
                            </li>
